...
namespace DasContract.Blockchain.Solidity.Tests.DMNBusinessRules
{
    public class AnyHitPolicyTest
    {
        ...
        public void DecisionFunctionTest()
        {
            ...
            decision.DecisionTable.HitPolicy = "ANY";
            ...
            string expected = "struct Decision_kowu89qOutput{\n" +
                            ...
                            "\t\t\tmatchedRule = true;\n" +
                            "\t\t}\n" +
                            "\t\telse if(categoryOne != 5 || categoryTwo != 6){\n" +
                            ...
                            "\t\t\tmatchedRule = true;\n" +
                            "\t\t}\n" +
                            "\t\telse if(categoryOne != 0 || categoryTwo != 0){\n" +
                            "\t\t\trevert('Undefined output');\n" +
                            "\t\t}\n" +
                            "\t}\n" +
                            ...
                            "\t\t\tmatchedRule = true;\n" +
                            "\t\t}\n" +
                            "\t\telse if(categoryOne != 1 || categoryTwo != 2){\n" +
                            "\t\t\trevert('Undefined output');\n" +
                            "\t\t}\n" +
                            "\t}\n" +
                            "\tif(!matchedRule){\n" +
